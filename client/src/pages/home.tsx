  ...
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a] selection:bg-[#ffaa4c] selection:text-white overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-full min-h-[800vh] z-0 overflow-hidden pointer-events-none">
        ...
        {/* Dark Orange - Top Left (Brighter Orange #ea580c, increased opacity) */}
        <div className="absolute top-[-2%] -left-[10%] w-[90%] h-[10%] rounded-full bg-[#ea580c] blur-[130px] opacity-70 mix-blend-multiply animate-blob"></div>
        {/* Light Orange - Top Right (Brighter Orange #f97316, increased opacity) */}
        <div className="absolute top-[1%] -right-[10%] w-[80%] h-[12%] rounded-full bg-[#f97316] blur-[110px] opacity-60 mix-blend-multiply animate-blob animation-delay-2000"></div>
        ...
        {/* New Orange Blob for Consumers Decide - Right side alongside grey (Smaller) */}
        <div className="absolute top-[24%] right-[0%] w-[25%] h-[10%] rounded-full bg-[#fb923c] blur-[120px] opacity-45 mix-blend-multiply"></div>
          ...
          <div className="space-y-16 relative">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:items-center group">
              <div className="flex-1 order-2 md:order-1 pl-16 md:pl-0">
                <FadeIn delay={0.1} className="md:ml-auto md:w-fit">
                  <h3 className="text-2xl font-normal mb-2">Upload Prospective Designs</h3>
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:items-center group">
              ...
              <div className="flex-1 order-2 md:order-3 pl-16 md:pl-0">
                 <FadeIn delay={0.2}>
                  <h3 className="text-2xl font-normal mb-2">Collect Community Feedback</h3>
                  <ul className="space-y-2 text-slate-600">
                    <li className="flex items-center gap-2">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:items-center group">
              <div className="flex-1 order-2 md:order-1 pl-16 md:pl-0">
                <FadeIn delay={0.3} className="md:ml-auto md:w-fit">
                  <h3 className="text-2xl font-normal mb-2">Predict Demand</h3>
                  <ul className="space-y-2 text-slate-600">
                     <li className="flex items-center gap-2">
